...
let SingletonPokemonClient: PokemonClient | undefined;

function getPokemonClient() {
  if (!SingletonPokemonClient) {
    SingletonPokemonClient = new PokemonClient({ cacheOptions: {} });
  }
  return SingletonPokemonClient;
}
...
export { getAppPkmnDetailFromApi, getImageConfigFromType, getPokemonClient };
